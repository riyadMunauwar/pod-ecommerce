    ...
    <section class="relative table w-full py-20 lg:py-24 bg-gray-50 dark:bg-slate-800">
        <div class="container relative">
            <div class="grid grid-cols-1 mt-14">
                <h3 class="text-3xl leading-normal font-semibold">Recent/Product</h3>
            </div><!--end grid-->
            ...
            <div class="relative mt-3">
                <ul class="breadcrumb tracking-[0.5px] mb-0 inline-block">
                    ...
                    <li class="inline breadcrumb-item uppercase text-[13px] font-bold text-indigo-600" aria-current="page">Recent/Popular</li>
                </ul>
            </div>
        </div><!--end container-->
    </section><!--end section-->
