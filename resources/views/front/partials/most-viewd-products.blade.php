    ...
    <div class="container relative mt-16">
        <div class="grid md:grid-cols-12 grid-cols-1 items-center">
            ...
            <div class="lg:col-span-4 md:col-span-6 md:text-end hidden md:block">
                <a href="shop-grid-two.html" class="btn btn-link text-slate-400 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">View More Items <i class="uil uil-arrow-right align-middle"></i></a>
            </div>
        </div><!--end grid-->
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s1.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s2.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s3.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s4.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s5.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s6.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s7.jpg') }}" alt="">
            ...
            <div class="group">
                <div class="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md transition-all duration-500">
                    <img src="{{ asset('techwind-assets/images/shop/items/s8.jpg') }}" alt="">
