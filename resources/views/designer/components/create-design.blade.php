            ...
            <div class="bg-white p-5 rounded-md  relative">
                ...
                <div class="space-y-5 rounded-md">
                    ...
                    <div>
                        ...
                        <input id="opacity" type="range" min="0.00" max="1.00" step="0.01" value="0" class="w-full h-1 mb-6 bg-gray-200 rounded-lg appearance-none cursor-pointer range-sm dark:bg-gray-700">
                    </div>
