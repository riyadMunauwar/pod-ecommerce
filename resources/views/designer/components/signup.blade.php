<div class="pb-20 main-container min-h-screen text-black dark:text-white-dark mt-20">
    ...
    <div class="flex items-center justify-center min-h-screen">
        ...
        <div class="relative flex w-full items-center justify-center lg:w-1/2">
            <div class="max-w-[480px] p-5 md:p-10">
                ...
                <p class="mb-7">Enter your email and password to register as a designer</p>
                
                <x-validation-errors />

                <form wire:submit.prevent="handleFormSubmit" class="space-y-5 mt-5">
                    <div>
                        <label for="name">Name</label>
                        <input wire:model.debounce="name" id="name" type="text" class="form-input" placeholder="Enter Name" />
                    </div>
                    <div>
                        <label for="email">Email</label>
                        <input wire:model.debounce="email" id="email" type="email" class="form-input" placeholder="Enter Email" />
                    </div>
                    <div>
                        <label for="password">Password</label>
                        <input wire:model.debounce="password" id="password" type="password" class="form-input" placeholder="Enter Password" />
                    </div>
                    <div>
                        <label for="password">Password Confirm</label>
                        <input wire:model.debounce="confirm" id="confirm" type="password" class="form-input" placeholder="Enter Password" />
                    </div>
                    <div>
                        <label class="cursor-pointer">
                            <input wire:model.debounce="tos" required type="checkbox" class="form-checkbox" />
                            <span class="text-white-dark"
                                >I agree the <a href="" class="text-primary hover:underline">Terms and Conditions</a></span
                            >
                        </label>
                    </div>
                    <button type="submit" class="btn btn-primary w-full">
                        <span wire:loading.remove >SIGN UP</span>
                        <div wire:loading wire:target=handleFormSubmit role="status">
                            <svg aria-hidden="true" class="inline w-6 h-6 mr-2 text-white animate-spin dark:text-gray-600 fill-gray-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
