...
<!-- Mirrored from html.vristo.sbthemes.com/auth-cover-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 14:14:43 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <title>Register Desinger | Elitg</title>
        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div class="flex min-h-screen">
                ...
                >
                    ...
                    <h3 class="mb-4 text-center text-3xl font-bold">Join the community of expert designer</h3>
                ...
                <div class="relative flex w-full items-center justify-center lg:w-1/2">
                    <div class="max-w-[480px] p-5 md:p-10">
                        ...
                        <p class="text-center">
                            Already have an account ? <a href="auth-cover-login.html" class="font-bold text-primary hover:underline">Sign In</a>
                        </p>
                    </div>
                </div>
            </div>
