...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="ltr">
    ...
    >
        ...
        @include('vendor.partials.sidebar-menu-overlay')

        @include('vendor.partials.screen-loader')

        @include('vendor.partials.scroll-top-button')

        @include('vendor.partials.right-panel')
