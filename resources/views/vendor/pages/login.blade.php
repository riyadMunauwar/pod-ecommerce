...
<!-- Mirrored from html.vristo.sbthemes.com/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 14:14:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
    <head>
        <meta charset="utf-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <title>Login Desinger | Elitg</title>
            ...
            <div class="flex min-h-screen">
                ...
                >
                    <div class="mx-auto mb-5 w-full">
                        <img src="{{ asset('assets/images/elitg-logo-white.png') }}" alt="Logo" class="mx-auto lg:max-w-[370px] xl:max-w-[500px]" />
                    </div>
                    <h3 class="mb-4 text-center text-3xl font-bold">Join the community of expert desinger</h3>
...
<!-- Mirrored from html.vristo.sbthemes.com/auth-cover-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Jun 2023 14:14:43 GMT -->
</html>
